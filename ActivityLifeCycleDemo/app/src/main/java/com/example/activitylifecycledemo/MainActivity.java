...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnStartNormalActivity = (Button)findViewById(R.id.start_normal_activity);
        Button btnStartDialogActivity = (Button)findViewById(R.id.start_dialog_activity);
